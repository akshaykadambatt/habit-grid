...
| 10     | Dark theme                              | System/light/dark with all states verified                |
...
| 10     | Add system/light/dark preference; extend semantic tokens; verify every screen and state in both themes                           |
